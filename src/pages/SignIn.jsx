 ...
 setUserData(result.data)
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-br from-[#0a0a1a] via-[#1a0a2e] to-[#0a0a1a] relative flex justify-center items-center overflow-hidden'>
      ...
      {/* Main Form Container */}
      <form className='relative w-[90%] max-w-[500px] bg-[#0a0a1a]/40 backdrop-blur-2xl border border-[#ffffff15] rounded-3xl shadow-2xl flex flex-col items-center justify-center gap-5 p-8 sm:p-10 z-10' onSubmit={handleSignIn}>
        {/* AI Icon/Logo */}
        ...
        <div className='text-center mb-4'>
          <h1 className='text-white text-3xl sm:text-4xl font-bold mb-2 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent'>Welcome Back</h1>
          <p className='text-gray-400 text-sm'>Sign in to your AI Assistant</p>
        </div>
        ...
        <p className='text-gray-400 text-base mt-2'>
          ...
          <span className='text-blue-400 hover:text-blue-300 cursor-pointer font-semibold ml-1 transition-colors' onClick={()=>navigate("/signup")}>
            Sign Up →
          </span>
        </p>
      </form>
